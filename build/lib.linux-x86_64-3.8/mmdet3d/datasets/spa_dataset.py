...
class SPADataset(Custom3DDataset):
    r"""KITTI Dataset.
    ...
    """
    CLASSES = ('car', 'pedestrian', 'cyclist', 'motorcyclist')
    ...
    def _get_pts_filename(self, idx):
        ...
        #                         f'{idx}.bin')
        pts_filename = osp.join(self.pts_prefix, f'{idx}.bin')
        return pts_filename
    ...
    def get_data_info(self, index):
        ...
        input_dict = dict(
            sample_idx=info['image']['image_idx'][0],
        ...
        for idx, img_path in enumerate(info['image']['image_path']):
